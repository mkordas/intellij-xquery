 ...
 * Time: 16:39
 */
public class XQueryRunConfigurationJavaTab extends SettingsEditor<XQueryRunConfiguration> implements PanelWithAnchor {
    ...
    public XQueryRunConfigurationJavaTab(final Project project) {
        ...
        anchor = UIUtil.mergeComponentsWithAnchor(commonJavaParametersPanel, alternativeJrePanel, moduleSelectorComponent);
    }
